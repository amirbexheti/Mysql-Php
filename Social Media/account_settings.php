...
<?php include 'header.php'; 
    ...
    if(isset($_POST['submit_htown'])){
        $h_town = $_POST['h_town'];
        $h_town = strip_tags($h_town); 
        $h_town = mysqli_real_escape_string($con, $h_town); 
            ...
            <div >
                ...
                <form action="account_settings.php" method="post"  enctype="multipart/form-data">
                    <tr class="r1">
                        ...
                        <td class="covet_img"> <span><h4>Change Cover Pic :<h4> <input type="file" name="cover_pic" id="cover"> <input type="submit" name="submit_cover_pic" value="Sublit"> <input type="submit" style="background: darkorange;" value="Cancel"></span> </td>
                    </tr>
